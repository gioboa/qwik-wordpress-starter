...
/** Connection between the Tours type and the MediaItem type */
...
/** Input for the createTour mutation. */
...
/** The payload for the createTour mutation. */
...
/** Input for the deleteTour mutation. */
...
/** The payload for the deleteTour mutation. */
...
/** The root mutation */
export type RootMutationCreateTourArgs = {
...
/** The root mutation */
export type RootMutationDeleteTourArgs = {
...
/** The root mutation */
export type RootMutationUpdateTourArgs = {
...
export type RootQuery = {
   ...
   */
  tourBy?: Maybe<Tour>;
  /** Connection between the RootQuery type and the tour type */
  tours?: Maybe<RootQueryToTourConnection>;
  /** Returns a user */
  user?: Maybe<User>;
  /** Returns a user role */
...
/** The root entry point into the Graph */
export type RootQueryTourArgs = {
  asPreview?: InputMaybe<Scalars["Boolean"]["input"]>;
  id: Scalars["ID"]["input"];
  idType?: InputMaybe<TourIdType>;
};

/** The root entry point into the Graph */
export type RootQueryTourByArgs = {
  id?: InputMaybe<Scalars["ID"]["input"]>;
...
/** The root entry point into the Graph */
export type RootQueryToursArgs = {
  after?: InputMaybe<Scalars["String"]["input"]>;
  before?: InputMaybe<Scalars["String"]["input"]>;
  first?: InputMaybe<Scalars["Int"]["input"]>;
  last?: InputMaybe<Scalars["Int"]["input"]>;
  where?: InputMaybe<RootQueryToTourConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the tour type */
export type RootQueryToTourConnection = Connection &
  TourConnection & {
    __typename?: "RootQueryToTourConnection";
    /** Edges for the RootQueryToTourConnection connection */
    edges: Array<RootQueryToTourConnectionEdge>;
    /** The nodes of the connection, without the edges */
    nodes: Array<Tour>;
    /** Information about pagination in a connection. */
    pageInfo: RootQueryToTourConnectionPageInfo;
  };

/** An edge in a connection */
export type RootQueryToTourConnectionEdge = Edge &
  TourConnectionEdge & {
    __typename?: "RootQueryToTourConnectionEdge";
    /** A cursor for use in pagination */
    cursor?: Maybe<Scalars["String"]["output"]>;
    /** The item at the end of the edge */
    node: Tour;
...
/** Page Info on the &quot;RootQueryToTourConnection&quot; */
export type RootQueryToTourConnectionPageInfo = PageInfo &
  TourConnectionPageInfo &
  WpPageInfo & {
    __typename?: "RootQueryToTourConnectionPageInfo";
    /** When paginating forwards, the cursor to continue. */
    endCursor?: Maybe<Scalars["String"]["output"]>;
    /** When paginating forwards, are there more items? */
    hasNextPage: Scalars["Boolean"]["output"];
...
/** Arguments for filtering the RootQueryToTourConnection connection */
export type RootQueryToTourConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars["Boolean"]["input"]>;
...
export type Tour = ContentNode &
  ...
  WithAcfTours & {
    ...
    /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
    guid?: Maybe<Scalars["String"]["output"]>;
    /** Whether the tour object is password protected. */
    hasPassword?: Maybe<Scalars["Boolean"]["output"]>;
    /** The globally unique identifier of the tour object. */
    id: Scalars["ID"]["output"];
    /** Whether the node is a Comment */
    isComment: Scalars["Boolean"]["output"];
    /** Whether the node is a Content Node */
    ...
    /** The globally unique identifier of the parent node. */
    parentId?: Maybe<Scalars["ID"]["output"]>;
    /** The password for the tour object. */
    password?: Maybe<Scalars["String"]["output"]>;
    /** Connection between the Tour type and the tour type */
    preview?: Maybe<TourToPreviewConnectionEdge>;
    /** The database id of the preview node */
    previewRevisionDatabaseId?: Maybe<Scalars["Int"]["output"]>;
    /** Whether the object is a node in the preview state */
    previewRevisionId?: Maybe<Scalars["ID"]["output"]>;
    ...
    /** Fields of the Tours ACF Field Group */
    tours?: Maybe<Tours>;
    /** The unique resource identifier path */
    uri?: Maybe<Scalars["String"]["output"]>;
  };
...
/** The tour type */
export type TourEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars["String"]["input"]>;
  before?: InputMaybe<Scalars["String"]["input"]>;
  first?: InputMaybe<Scalars["Int"]["input"]>;
  last?: InputMaybe<Scalars["Int"]["input"]>;
...
/** The tour type */
export type TourEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars["String"]["input"]>;
  before?: InputMaybe<Scalars["String"]["input"]>;
  first?: InputMaybe<Scalars["Int"]["input"]>;
  last?: InputMaybe<Scalars["Int"]["input"]>;
...
/** Connection to tour Nodes */
export type TourConnection = {
  /** A list of edges (relational context) between RootQuery and connected tour Nodes */
  edges: Array<TourConnectionEdge>;
  /** A list of connected tour Nodes */
  nodes: Array<Tour>;
  /** Information about pagination in a connection. */
  pageInfo: TourConnectionPageInfo;
};

/** Edge between a Node and a connected tour */
export type TourConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars["String"]["output"]>;
  /** The connected tour Node */
  node: Tour;
};

/** Page Info on the connected TourConnectionEdge */
export type TourConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars["String"]["output"]>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars["Boolean"]["output"];
...
/** Connection between the Tour type and the tour type */
export type TourToPreviewConnectionEdge = Edge &
  OneToOneConnection &
  TourConnectionEdge & {
    __typename?: "TourToPreviewConnectionEdge";
    /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
    cursor?: Maybe<Scalars["String"]["output"]>;
    /** The node of the connection, without the edges */
    node: Tour;
...
/** The &quot;Tours&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type Tours = AcfFieldGroup &
  AcfFieldGroupFields &
  Tours_Fields & {
    __typename?: "Tours";
    ...
    busTransportation?: Maybe<Scalars["Boolean"]["output"]>;
    /** FareHarbor Booking URL. */
    calendarId?: Maybe<Scalars["String"]["output"]>;
    /** A quick description of the tour to be used on tour cards on the site. Short. */
    cardDescription?: Maybe<Scalars["String"]["output"]>;
    /** Ex. Thursday-Monday, 1 p.m. */
    datesTimesBreakdown?: Maybe<Scalars["String"]["output"]>;
    /** The main description of the tour, just below the hero section. */
    description?: Maybe<Scalars["String"]["output"]>;
    /** Distance of tour in miles. */
    distance?: Maybe<Scalars["Float"]["output"]>;
    /** Ex. 0.6 miles (Suitable for all ages and fitness levels.) */
    distanceBreakdown?: Maybe<Scalars["String"]["output"]>;
    /** Duration of tour. */
    duration?: Maybe<Scalars["Float"]["output"]>;
    /** The EmbedSocial widget ID. */
    embedsocialReviewEmbedId?: Maybe<Scalars["String"]["output"]>;
    /** The JSON schema for EmbedSocial star ratings. */
    embedsocialSchema?: Maybe<Scalars["String"]["output"]>;
    /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;Tours&quot; Field Group */
    faqs?: Maybe<Array<Maybe<ToursFaqs>>>;
    /** Title before faqs. */
    faqsTitle?: Maybe<Scalars["String"]["output"]>;
    /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;Tours&quot; Field Group */
    featuredReview?: Maybe<Scalars["String"]["output"]>;
    /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;Tours&quot; Field Group */
    featuredReviewerName?: Maybe<Scalars["String"]["output"]>;
    /**
     * The name of the field group
     * @deprecated Use __typename instead
     */
    fieldGroupName?: Maybe<Scalars["String"]["output"]>;
    /** Field of the &quot;repeater&quot; Field Type added to the schema as part of the &quot;Tours&quot; Field Group */
    gallery?: Maybe<Array<Maybe<ToursGallery>>>;
    /** Distance of tour in miles. */
    goodForFirstTimeVisitors?: Maybe<Scalars["Boolean"]["output"]>;
    /** Distance of tour in miles. */
    greatForLargeGroups?: Maybe<Scalars["Boolean"]["output"]>;
    /** Distance of tour in miles. */
    greatForSmallGroups?: Maybe<Scalars["Boolean"]["output"]>;
    /** Ex. 16 guests max, led by a fun, expert guide. */
    guestCountBreakdown?: Maybe<Scalars["String"]["output"]>;
    /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;Tours&quot; Field Group */
    heroImage?: Maybe<AcfMediaItemConnectionEdge>;
    /** Distance of tour in miles. */
    localFavorite?: Maybe<Scalars["Boolean"]["output"]>;
    /** The heading that appears above the main description of the tour, just below the hero section. */
    mainContentHeading?: Maybe<Scalars["String"]["output"]>;
    /** One per line. */
    ...
    /** The image that appears below the booking card promoting private tours. */
    privateTourThumbnail?: Maybe<AcfMediaItemConnectionEdge>;
    /** Title before the reviews carousel section. */
    socialProofTitle?: Maybe<Scalars["String"]["output"]>;
    /** An optional field to add a tag to cards and in the hero area of the tour page. */
    tagline?: Maybe<Scalars["String"]["output"]>;
    /** Image to the left of the letter. */
    theresasLetterImage?: Maybe<AcfMediaItemConnectionEdge>;
    /** The left image above the message. */
    theresasLetterImage1?: Maybe<AcfMediaItemConnectionEdge>;
    /** The overlay for the left image above the message. */
    theresasLetterImage1Overlay?: Maybe<AcfMediaItemConnectionEdge>;
    /** The right image above the message. */
    theresasLetterImage2?: Maybe<AcfMediaItemConnectionEdge>;
    /** Field of the &quot;wysiwyg&quot; Field Type added to the schema as part of the &quot;Tours&quot; Field Group */
    theresasLetterMessage?: Maybe<Scalars["String"]["output"]>;
    /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;Tours&quot; Field Group */
    theresasLetterTitle?: Maybe<Scalars["String"]["output"]>;
    /** The tour highlights. Use bullet points. */
    tourHighlights?: Maybe<Scalars["String"]["output"]>;
    /** Title before tour highlights description. */
    tourHighlightsTitle?: Maybe<Scalars["String"]["output"]>;
    /** Toggle if tour regularly sells out. */
    tourSellsOut?: Maybe<Scalars["Boolean"]["output"]>;
    /** Does this tour offer vegetarian options? */
    vegetarianOptions?: Maybe<Scalars["Boolean"]["output"]>;
    /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;Tours&quot; Field Group */
    vegetarianOptionsText?: Maybe<Scalars["String"]["output"]>;
  };

/** The &quot;ToursFaqs&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type ToursFaqs = AcfFieldGroup &
  AcfFieldGroupFields &
  ToursFaqs_Fields & {
    __typename?: "ToursFaqs";
    /** Field of the &quot;wysiwyg&quot; Field Type added to the schema as part of the &quot;ToursFaqs&quot; Field Group */
     ...
     */
    fieldGroupName?: Maybe<Scalars["String"]["output"]>;
    /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;ToursFaqs&quot; Field Group */
    question?: Maybe<Scalars["String"]["output"]>;
  };

/** Interface representing fields of the ACF &quot;ToursFaqs&quot; Field Group */
export type ToursFaqs_Fields = {
  /** Field of the &quot;wysiwyg&quot; Field Type added to the schema as part of the &quot;ToursFaqs&quot; Field Group */
  answer?: Maybe<Scalars["String"]["output"]>;
  /**
   * The name of the field group
...
/** The &quot;ToursGallery&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type ToursGallery = AcfFieldGroup &
  AcfFieldGroupFields &
  ToursGallery_Fields & {
    __typename?: "ToursGallery";
    /**
     * The name of the field group
     * @deprecated Use __typename instead
     */
    fieldGroupName?: Maybe<Scalars["String"]["output"]>;
    /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;ToursGallery&quot; Field Group */
    image?: Maybe<AcfMediaItemConnectionEdge>;
  };

/** Interface representing fields of the ACF &quot;ToursGallery&quot; Field Group */
export type ToursGallery_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;Tours&quot; Field Group */
export type Tours_Fields = {
  /** FareHarbor Booking URL. */
  bookingId?: Maybe<Scalars["String"]["output"]>;
  /** Distance of tour in miles. */
  busTransportation?: Maybe<Scalars["Boolean"]["output"]>;
...
/** Input for the updateTour mutation. */
...
/** The payload for the updateTour mutation. */
...
/** Provides access to fields of the &quot;Tours&quot; ACF Field Group via the &quot;tours&quot; field */
export type WithAcfTours = {
  /** Fields of the Tours ACF Field Group */
  tours?: Maybe<Tours>;
};
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    AllPosts(
      ...
      return requester<AllPostsQuery, AllPostsQueryVariables>(
        AllPostsDocument,
        variables,
        options,
